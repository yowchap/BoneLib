...
namespace BoneLib.BoneMenu.UI
{
    public class GUIMenu : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            _scrollUpButton.onClick.AddListener(ScrollUp);
            _scrollDownButton.onClick.AddListener(ScrollDown);

            _toParentButton.onClick.AddListener(ToParentPage);
            _decrementPageButton.onClick.AddListener(Menu.PreviousPage);
            _incrementPageButton.onClick.AddListener(Menu.NextPage);
        }
